...
namespace ET\Bannerslider\Model\ResourceModel;
...
class Banner extends AbstractDb {
     ...
     * Load an object
     *
     * @param \ET\Bannerslider\Model\Banner|AbstractModel $object
     * @param mixed $value
    ...
    protected function _getLoadSelect($field, $value, $object) {
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                            ['cbs' => $this->getTable('et_bannerslider_store')], $this->getMainTable() . '.' . $linkField . ' = cbs.' . $linkField, ['store_id']
                    )
                    ->where('is_active = ?', 1)
    ...
    public function getIsUniqueBannerToStores(AbstractModel $object) {
        ...
        $select = $this->getConnection()->select()
                ...
                ->join(
                        ['cbs' => $this->getTable('et_bannerslider_store')], 'cb.' . $linkField . ' = cbs.' . $linkField, []
                )
    ...
    public function lookupStoreIds($id) {
        ...
        $select = $connection->select()
                ->from(['cbs' => $this->getTable('et_bannerslider_store')], 'store_id')
                ->join(
