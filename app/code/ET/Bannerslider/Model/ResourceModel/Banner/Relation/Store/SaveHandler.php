...
namespace ET\Bannerslider\Model\ResourceModel\Banner\Relation\Store;

use Magento\Framework\EntityManager\Operation\ExtensionInterface;
use ET\Bannerslider\Api\Data\BannerInterface;
use ET\Bannerslider\Model\ResourceModel\Banner;
...
class SaveHandler implements ExtensionInterface {
    ...
    MetadataPool $metadataPool, Banner $resourceBanner
    ) {
    ...
    public function execute($entity, $arguments = []) {
        ...
        $table = $this->resourceBanner->getTable('et_bannerslider_store');
