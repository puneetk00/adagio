...
namespace ET\Promotionbar\Ui\Component\Form\Promotion;

use Magento\Store\Model\StoreManagerInterface;
use ET\Promotionbar\Model\ResourceModel\Promotion\Collection;
            ...
            foreach ($items as $item) {
                ...
                if (isset($itemData['img'])) {
                    ...
                    $itemData['img'] = [
                        [
                            'name' => $imageName[3],
                            'url' => $this->storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . 'promotionbar/image' . $itemData['img'],
                        ],
                    ];
                } else {
                    $itemData['img'] = null;
