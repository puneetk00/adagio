...
class Demoversion implements \Magento\Framework\Option\ArrayInterface
{
    public function toOptionArray()
    {
        return [
            ...
            ['value' => '15', 'label' => __('Demo 15')],
            ['value' => '16', 'label' => __('Demo 16')],
            ['value' => '17', 'label' => __('Demo 17')],
            ['value' => '18', 'label' => __('Demo 18')],
            ['value' => '19', 'label' => __('Demo 19')],
            ['value' => '20', 'label' => __('Demo 20')],
            ['value' => '21', 'label' => __('Demo 21')],
            ['value' => '22', 'label' => __('Demo 22')]
        ];
    }
}