...
namespace ET\Orderfeedback\Ui\Component\Listing\Column;

class FeedbackActions extends \Magento\Ui\Component\Listing\Columns\Column {

    const URL_DELETE_PATH = 'orderfeedback/index/delete';
