...
namespace ET\Theme\Block\System\Config\Form\Button\Import;

class Cmsfooter extends \Magento\Config\Block\System\Config\Form\Field
{
    /**
     * Button Label
     *
     ...
     * @return \ET\Theme\Block\System\Config\Form\Button\Import\Cmsfooter
     */
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('system/config/footer_button.phtml');
        }
        return $this;
    }
